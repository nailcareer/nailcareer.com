...
const markdown = (() => {
    ...
    return (md) => markdown.render(md);
})();
export default ({ product: { title, product, carousel, writeup, writeupMarkdown, youtubeEmbed, details, }, imagesDirectory, ...context }) => pageHtml({
    ...context,
    pageName: "store",
    pageSubtitle: title,
    mainHtml: html `
...
//# sourceMappingURL=product-page.html.js.map