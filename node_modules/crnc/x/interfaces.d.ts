...
export declare type BankOfCanadaSupportedCurrencies = typeof bankOfCanadaSupportedCurrencies[number];
export declare type SupportedCurrency = keyof typeof currencyLibrary;
export declare type SupportedCurrencies = SupportedCurrency[];
...
export declare type DownloadExchangeRates = ({}: DownloadExchangeRatesParams) => Promise<DownloadExchangeRatesResults>;
