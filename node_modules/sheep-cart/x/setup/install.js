...
export function install_sheep_cart({ domain, storefront_access_token, page_size = 50, home = "products", theme = default_theme, }) {
    const shopify = Shopify.setup({
        domain,
        storefront_access_token,
    });
    const router = Router.setup(home);
    const context = new Context(shopify, router, theme, new CartStore("sheep_cart", localStorage));
