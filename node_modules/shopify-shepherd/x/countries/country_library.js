...
export class CountryLibrary extends Map {
    constructor() {
        super();
        for (const item of country_data) {
            const { name, "alpha-2": two_letter, "country-code": numerical, } = item;
            this.set(two_letter, { name, numerical, two_letter });
        }
    }
    query(two_letter_codes) {
        const known = [];
        const unknown = [];
...
//# sourceMappingURL=country_library.js.map