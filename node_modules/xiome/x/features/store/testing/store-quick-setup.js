...
export async function setupSimpleStoreClient(...privileges) {
...
export async function setupLinkedStore() {
    ...
    async function makeMerchantClient() {
        ...
        await merchantClient.setAccessWithPrivileges(...Object.values(storePowerPrivileges));
    ...
    return {
        ...
        async makeClerkClient() {
            const client = await makeClient();
            await client.setAccessWithPrivileges(storePrivileges["manage store"], storePrivileges["give away freebies"]);
            await client.storeModel.connectSubmodel.activate();
            return client;
        },
    };
...
// }
//# sourceMappingURL=store-quick-setup.js.map