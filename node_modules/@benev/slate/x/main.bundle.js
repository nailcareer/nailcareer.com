...
class Locker {
    ...
    lock(fn) {
        __classPrivateFieldSet$k(this, _Locker_locked, true, "f");
        const result = fn();
        __classPrivateFieldSet$k(this, _Locker_locked, false, "f");
        return result;
    }
    get locked() {
        return __classPrivateFieldGet$r(this, _Locker_locked, "f");
    }
}
...
function maptool(map) {
    return {
        guarantee: (key, make) => (mapGuarantee(map, key, make)),
    };
}
function mapGuarantee(map, key, make) {
    if (map.has(key))
        return map.get(key);
    else {
        const value = make();
...
class Tracker {
    ...
    grab_keymap(state) {
        const keymap = maptool(__classPrivateFieldGet$q(this, _Tracker_tracking, "f")).guarantee(state, make_map);
        return {
            keymap,
            grab_symbolmap(key) {
    ...
    clear() {
        __classPrivateFieldSet$j(this, _Tracker_tracking, new WeakMap(), "f");
    }
}
...
class Stopper {
    ...
    stop(symbol) {
        const stop = __classPrivateFieldGet$p(this, _Stopper_map, "f").get(symbol);
        if (stop) {
            __classPrivateFieldGet$p(this, _Stopper_map, "f").delete(symbol);
            stop();
        }
    }
    add(symbol, fun) {
        __classPrivateFieldGet$p(this, _Stopper_map, "f").set(symbol, fun);
    }
}
...
class Recorder {
    ...
    record(fn) {
        ...
        __classPrivateFieldGet$o(this, _Recorder_recordings, "f").push(recording);
        const payload = fn();
        __classPrivateFieldGet$o(this, _Recorder_recordings, "f").pop();
        return { payload, recording };
    }
    record_that_key_was_accessed(state, key) {
        const recording = __classPrivateFieldGet$o(this, _Recorder_recordings, "f").at(-1);
        if (recording) {
...
class Scheduler {
    constructor() {
        ...
        _Scheduler_actuate.set(this, debounce(0, () => {
            const functions = [...__classPrivateFieldGet$n(this, _Scheduler_queue, "f").values()];
            __classPrivateFieldGet$n(this, _Scheduler_queue, "f").clear();
            for (const fun of functions)
                fun();
        }));
    }
    get wait() {
        return __classPrivateFieldGet$n(this, _Scheduler_wait, "f");
    }
    add(symbol, fun) {
        __classPrivateFieldGet$n(this, _Scheduler_queue, "f").set(symbol, fun);
        __classPrivateFieldSet$i(this, _Scheduler_wait, __classPrivateFieldGet$n(this, _Scheduler_actuate, "f").call(this), "f");
    }
}
...
class Flat {
    constructor() {
        ...
        _Flat_proxy_handlers.set(this, proxy_handlers(__classPrivateFieldGet$m(this, _Flat_tracker, "f"), __classPrivateFieldGet$m(this, _Flat_recorder, "f"), __classPrivateFieldGet$m(this, _Flat_locker, "f"), __classPrivateFieldGet$m(this, _Flat_stopper, "f"), __classPrivateFieldGet$m(this, _Flat_scheduler, "f")));
    }
    get wait() {
        return __classPrivateFieldGet$m(this, _Flat_scheduler, "f").wait;
    }
    state(state) {
        return new Proxy(state, __classPrivateFieldGet$m(this, _Flat_proxy_handlers, "f"));
    }
    reaction(collector, responder) {
        const symbol = Symbol();
        const { recording } = __classPrivateFieldGet$m(this, _Flat_recorder, "f").record(() => __classPrivateFieldGet$m(this, _Flat_locker, "f").lock(collector));
        __classPrivateFieldGet$m(this, _Flat_stopper, "f").add(symbol, save_reaction(symbol, recording, __classPrivateFieldGet$m(this, _Flat_tracker, "f"), { collector, responder }));
        return () => __classPrivateFieldGet$m(this, _Flat_stopper, "f").stop(symbol);
    }
    lean(actor) {
        const symbol = Symbol();
        return {
            stop: () => __classPrivateFieldGet$m(this, _Flat_stopper, "f").stop(symbol),
            collect: collector => {
                const { payload, recording } = __classPrivateFieldGet$m(this, _Flat_recorder, "f").record(() => __classPrivateFieldGet$m(this, _Flat_locker, "f").lock(collector));
                __classPrivateFieldGet$m(this, _Flat_stopper, "f").add(symbol, save_reaction(symbol, recording, __classPrivateFieldGet$m(this, _Flat_tracker, "f"), { lean: true, actor }));
                return payload;
            },
        };
    }
    clear() {
        __classPrivateFieldGet$m(this, _Flat_tracker, "f").clear();
    }
}
...
class Slice {
    constructor(options) {
        ...
        __classPrivateFieldSet$h(this, _Slice_options, options, "f");
    }
    get state() {
        return __classPrivateFieldGet$l(this, _Slice_options, "f").getter(__classPrivateFieldGet$l(this, _Slice_options, "f").parent.state);
    }
    transmute(fun) {
        __classPrivateFieldGet$l(this, _Slice_options, "f").parent.transmute(state => {
            const x1 = __classPrivateFieldGet$l(this, _Slice_options, "f").getter(state);
            const x2 = fun(x1);
            const new_state = __classPrivateFieldGet$l(this, _Slice_options, "f").setter(state, x2);
            return new_state;
        });
    }
    slice({ getter, setter }) {
...
class StateTree {
    constructor(state, onChange = () => { }) {
        ...
        __classPrivateFieldSet$g(this, _StateTree_state, structuredClone(state), "f");
        __classPrivateFieldSet$g(this, _StateTree_readable, __classPrivateFieldGet$k(this, _StateTree_instances, "m", _StateTree_make_frozen_clone).call(this), "f");
        __classPrivateFieldSet$g(this, _StateTree_onChange, onChange, "f");
    }
    get state() {
        return __classPrivateFieldGet$k(this, _StateTree_readable, "f");
    }
    transmute(fun) {
        if (__classPrivateFieldGet$k(this, _StateTree_circularity_lock, "f"))
            throw new Error("circular error");
        __classPrivateFieldSet$g(this, _StateTree_circularity_lock, true, "f");
        __classPrivateFieldSet$g(this, _StateTree_state, fun(structuredClone(__classPrivateFieldGet$k(this, _StateTree_state, "f"))), "f");
        __classPrivateFieldSet$g(this, _StateTree_readable, __classPrivateFieldGet$k(this, _StateTree_instances, "m", _StateTree_make_frozen_clone).call(this), "f");
        __classPrivateFieldGet$k(this, _StateTree_onChange, "f").call(this);
        __classPrivateFieldSet$g(this, _StateTree_circularity_lock, false, "f");
    }
    slice({ getter, setter }) {
        return new Slice({
            parent: this,
...
_StateTree_state = new WeakMap(), _StateTree_readable = new WeakMap(), _StateTree_onChange = new WeakMap(), _StateTree_circularity_lock = new WeakMap(), _StateTree_instances = new WeakSet(), _StateTree_make_frozen_clone = function _StateTree_make_frozen_clone() {
    return deep.freeze(structuredClone(__classPrivateFieldGet$k(this, _StateTree_state, "f")));
};
...
class WatchTower {
    constructor(signals) {
        ...
        __classPrivateFieldSet$f(this, _WatchTower_signals, signals, "f");
    }
    dispatch() {
        for (const computed of __classPrivateFieldGet$j(this, _WatchTower_computeds, "f"))
            computed();
        for (const listener of __classPrivateFieldGet$j(this, _WatchTower_listeners, "f"))
            listener();
    }
    computed(fun) {
        const box = __classPrivateFieldGet$j(this, _WatchTower_signals, "f").signal(fun());
        __classPrivateFieldGet$j(this, _WatchTower_computeds, "f").add(() => { box.value = fun(); });
        return box;
    }
    track(collector, responder) {
        ...
        const listener = () => {
            ...
            const previous = __classPrivateFieldGet$j(this, _WatchTower_memory, "f").get(collector);
            if (first || !deep.equal(current, previous)) {
                first = false;
                __classPrivateFieldGet$j(this, _WatchTower_memory, "f").set(collector, current);
                responder(current);
            }
        };
        listener();
        __classPrivateFieldGet$j(this, _WatchTower_listeners, "f").add(listener);
        return collector();
    }
    stateTree(state) {
...
class Reactor {
    ...
    get wait() {
        return Promise
            ...
            .then(() => __classPrivateFieldGet$i(this, _Reactor_wait, "f"));
    }
    reaction(collector, responder) {
...
var _Signal_value, _Signal_lock, _Signal_wait, _Signal_listeners, _Signal_invoke_listeners, _a$1;
class Signal {
    constructor(v) {
        ...
        _Signal_invoke_listeners.set(this, debounce(0, () => {
            const value = __classPrivateFieldGet$h(this, _Signal_value, "f");
            __classPrivateFieldSet$e(this, _Signal_lock, true, "f");
            for (const listener of __classPrivateFieldGet$h(this, _Signal_listeners, "f"))
                listener(value);
            __classPrivateFieldSet$e(this, _Signal_lock, false, "f");
            return value;
        }));
        __classPrivateFieldSet$e(this, _Signal_value, v, "f");
        __classPrivateFieldSet$e(this, _Signal_wait, Promise.resolve(v), "f");
    }
    subscribe(listener) {
        __classPrivateFieldGet$h(this, _Signal_listeners, "f").add(listener);
        return () => void __classPrivateFieldGet$h(this, _Signal_listeners, "f").delete(listener);
    }
    once(listener) {
        const actual_listener = v => {
            listener(v);
            __classPrivateFieldGet$h(this, _Signal_listeners, "f").delete(actual_listener);
        };
        __classPrivateFieldGet$h(this, _Signal_listeners, "f").add(actual_listener);
        return () => void __classPrivateFieldGet$h(this, _Signal_listeners, "f").delete(actual_listener);
    }
    clear() {
        return __classPrivateFieldGet$h(this, _Signal_listeners, "f").clear();
    }
    async publish() {
        __classPrivateFieldSet$e(this, _Signal_wait, __classPrivateFieldGet$h(this, _Signal_invoke_listeners, "f").call(this), "f");
        await __classPrivateFieldGet$h(this, _Signal_wait, "f");
    }
    get wait() {
        return __classPrivateFieldGet$h(this, _Signal_wait, "f");
    }
    get value() {
        this[accessed] = true;
        return __classPrivateFieldGet$h(this, _Signal_value, "f");
    }
    set value(s) {
        if (__classPrivateFieldGet$h(this, _Signal_lock, "f"))
            throw new SignalCircularError("you can't set a signal in a signal's subscription listener (infinite loop forbidden)");
        __classPrivateFieldSet$e(this, _Signal_value, s, "f");
        this.publish();
    }
}
_Signal_value = new WeakMap(), _Signal_lock = new WeakMap(), _Signal_wait = new WeakMap(), _Signal_listeners = new WeakMap(), _Signal_invoke_listeners = new WeakMap(), _a$1 = accessed;
Signal.unwrap = ((anything) => {
...
class OpSignal extends Signal {
    ...
    async load(operation) {
        return Op.load(op => this.value = op, operation);
    }
    setLoading() {
...
class SignalTracker {
    constructor({ all_signals, waiters, }) {
        ...
        _SignalTracker_actuate.set(this, debounce(0, (track) => {
            if (__classPrivateFieldGet$g(this, _SignalTracker_active, "f")) {
                if ("lean" in track)
                    track.actor();
                else {
        ...
        __classPrivateFieldSet$d(this, _SignalTracker_all_signals, all_signals, "f");
        __classPrivateFieldSet$d(this, _SignalTracker_waiters, waiters, "f");
    }
    observe(collector) {
        __classPrivateFieldGet$g(this, _SignalTracker_instances, "m", _SignalTracker_reset_all_signals_accessed_indicator).call(this);
        const payload = collector();
        return {
            payload,
            recording: __classPrivateFieldGet$g(this, _SignalTracker_instances, "a", _SignalTracker_signals_that_should_be_tracked_get),
        };
    }
    add_listeners(track, recording) {
        for (const signal of recording) {
            __classPrivateFieldGet$g(this, _SignalTracker_relevant_signals, "f").add(signal);
            __classPrivateFieldGet$g(this, _SignalTracker_stoppers, "f").add(signal.subscribe(() => __classPrivateFieldGet$g(this, _SignalTracker_waiters, "f").add(__classPrivateFieldGet$g(this, _SignalTracker_actuate, "f").call(this, track))));
        }
    }
    shutdown() {
        __classPrivateFieldSet$d(this, _SignalTracker_active, false, "f");
        __classPrivateFieldGet$g(this, _SignalTracker_stoppers, "f").forEach(stop => stop());
    }
}
_SignalTracker_active = new WeakMap(), _SignalTracker_all_signals = new WeakMap(), _SignalTracker_waiters = new WeakMap(), _SignalTracker_relevant_signals = new WeakMap(), _SignalTracker_stoppers = new WeakMap(), _SignalTracker_actuate = new WeakMap(), _SignalTracker_instances = new WeakSet(), _SignalTracker_reset_all_signals_accessed_indicator = function _SignalTracker_reset_all_signals_accessed_indicator() {
    for (const signal of __classPrivateFieldGet$g(this, _SignalTracker_all_signals, "f"))
    ...
    return [...__classPrivateFieldGet$g(this, _SignalTracker_all_signals, "f")].filter(signal => (signal[accessed] &&
        !__classPrivateFieldGet$g(this, _SignalTracker_relevant_signals, "f").has(signal)));
};
...
class SignalTower {
    ...
    signal(value) {
        ...
        __classPrivateFieldGet$f(this, _SignalTower_signals, "f").add(signal);
        return signal;
    }
    computed(fun) {
    ...
    reaction(collector, responder) {
        const tracker = new SignalTracker({
            waiters: __classPrivateFieldGet$f(this, _SignalTower_waiters, "f"),
            all_signals: __classPrivateFieldGet$f(this, _SignalTower_signals, "f"),
        });
    ...
    get wait() {
        return Promise.all([...__classPrivateFieldGet$f(this, _SignalTower_signals, "f")].map(s => s.wait))
            .then(() => Promise.all([...__classPrivateFieldGet$f(this, _SignalTower_waiters, "f")]))
            .then(() => { __classPrivateFieldGet$f(this, _SignalTower_waiters, "f").clear(); });
    }
}
...
function mixinSetups(Base) {
    ...
    return _a = class extends Base {
            ...
            register_setup(setup) {
                __classPrivateFieldGet$e(this, _setups, "f").add(setup);
            }
            setup() {
                return () => { };
            }
            connectedCallback() {
                for (const setup of __classPrivateFieldGet$e(this, _setups, "f"))
                    __classPrivateFieldGet$e(this, _setdowns, "f").add(setup());
            }
            disconnectedCallback() {
                for (const setdown of __classPrivateFieldGet$e(this, _setdowns, "f"))
                    setdown();
                __classPrivateFieldGet$e(this, _setdowns, "f").clear();
            }
        },
        _setups = new WeakMap(),
...
class GoldElement extends MetallicElement {
    ...
    constructor() {
        ...
        _GoldElement_wait.set(this, __classPrivateFieldGet$d(this, _GoldElement_init, "f").promise);
        _GoldElement_render_debounced.set(this, debounce(0, () => {
            const root = __classPrivateFieldGet$d(this, _GoldElement_root, "f");
            const template = this.render();
            if (template)
                j(template, root, { host: this });
        }));
        __classPrivateFieldSet$c(this, _GoldElement_root, this.attachShadow({ mode: "open" }), "f");
        const C = this.constructor;
        apply_styles_to_shadow(__classPrivateFieldGet$d(this, _GoldElement_root, "f"), C.styles);
        this.init();
    }
    get root() {
        return __classPrivateFieldGet$d(this, _GoldElement_root, "f");
    }
    get updateComplete() {
        return __classPrivateFieldGet$d(this, _GoldElement_wait, "f").then(() => true);
    }
    render() { }
    async requestUpdate() {
        const promise = __classPrivateFieldGet$d(this, _GoldElement_render_debounced, "f").call(this);
        if (__classPrivateFieldGet$d(this, _GoldElement_init, "f")) {
            promise.then(__classPrivateFieldGet$d(this, _GoldElement_init, "f").resolve);
            __classPrivateFieldSet$c(this, _GoldElement_init, undefined, "f");
        }
        __classPrivateFieldSet$c(this, _GoldElement_wait, promise, "f");
        return promise;
    }
    connectedCallback() {
...
class SlateGold extends GoldElement {
    ...
    render() {
        return x `
			<span>${__classPrivateFieldGet$c(this, _SlateGold_state, "f").count}</span>
			<button @click=${() => __classPrivateFieldGet$c(this, _SlateGold_state, "f").count++}>gold</button>
		`;
    }
}
...
class Shell {
    constructor(context) {
        ...
        __classPrivateFieldSet$b(this, _Shell_context, context, "f");
    }
    get context() {
        if (__classPrivateFieldGet$b(this, _Shell_context, "f"))
            return __classPrivateFieldGet$b(this, _Shell_context, "f");
        else
    ...
    function signals(signals) {
        return function (Base) {
            ...
            return _a = class extends Base {
                    ...
                    render() {
                        var _b;
                        return (_b = __classPrivateFieldGet$a(this, _lean, "f")) === null || _b === void 0 ? void 0 : _b.collect(() => super.render());
                    }
                    connectedCallback() {
                        super.connectedCallback();
                        __classPrivateFieldSet$a(this, _lean, signals.lean(() => this.requestUpdate()), "f");
                    }
                    disconnectedCallback() {
                        super.disconnectedCallback();
                        if (__classPrivateFieldGet$a(this, _lean, "f")) {
                            __classPrivateFieldGet$a(this, _lean, "f").stop();
                            __classPrivateFieldSet$a(this, _lean, null, "f");
                        }
                    }
                },
                _lean = new WeakMap(),
    ...
    function flat(flat) {
        return function (Base) {
            ...
            return _a = class extends Base {
                    ...
                    render() {
                        var _b;
                        return (_b = __classPrivateFieldGet$a(this, _lean_1, "f")) === null || _b === void 0 ? void 0 : _b.collect(() => super.render());
                    }
                    connectedCallback() {
                        super.connectedCallback();
                        __classPrivateFieldSet$a(this, _lean_1, flat.lean(() => this.requestUpdate()), "f");
                    }
                    disconnectedCallback() {
                        super.disconnectedCallback();
                        if (__classPrivateFieldGet$a(this, _lean_1, "f")) {
                            __classPrivateFieldGet$a(this, _lean_1, "f").stop();
                            __classPrivateFieldSet$a(this, _lean_1, null, "f");
                        }
                    }
                },
                _lean_1 = new WeakMap(),
    ...
    function reactor$1(r = reactor) {
        return function (Base) {
            ...
            return _a = class extends Base {
                    ...
                    render() {
                        var _b;
                        return (_b = __classPrivateFieldGet$a(this, _lean_2, "f")) === null || _b === void 0 ? void 0 : _b.collect(() => super.render());
                    }
                    connectedCallback() {
                        super.connectedCallback();
                        __classPrivateFieldSet$a(this, _lean_2, r.lean(() => this.requestUpdate()), "f");
                    }
                    disconnectedCallback() {
                        super.disconnectedCallback();
                        if (__classPrivateFieldGet$a(this, _lean_2, "f")) {
                            __classPrivateFieldGet$a(this, _lean_2, "f").stop();
                            __classPrivateFieldSet$a(this, _lean_2, null, "f");
                        }
                    }
                },
                _lean_2 = new WeakMap(),
...
class Pipe {
    ...
    constructor(input) {
        ...
        __classPrivateFieldSet$9(this, _Pipe_input, input, "f");
    }
    to(fun) {
        return new Pipe(fun(__classPrivateFieldGet$9(this, _Pipe_input, "f")));
    }
    done() {
        return __classPrivateFieldGet$9(this, _Pipe_input, "f");
    }
}
...
var apply;
(function (apply) {
    apply.css = ((theme) => ((elements) => (ob(elements).map(Element => mixin.css(theme)(Element)))));
    apply.flat = ((flat) => ((elements) => (ob(elements).map((Element) => mixin.flat(flat)(Element)))));
    apply.signals = ((signals) => ((elements) => (ob(elements).map((Element) => mixin.signals(signals)(Element)))));
    apply.reactor = ((r = reactor) => ((elements) => (ob(elements).map((Element) => mixin.reactor(r)(Element)))));
...
class Counter {
    ...
    pull() {
        var _a, _b;
        return __classPrivateFieldSet$8(this, _Counter_value, (_b = __classPrivateFieldGet$8(this, _Counter_value, "f"), _a = _b++, _b), "f"), _a;
    }
    reset() {
        __classPrivateFieldSet$8(this, _Counter_value, 0, "f");
    }
}
...
class Use {
    constructor(rerender, context) {
        this[_a] = {
            wrap: (fn) => {
                return ((...args) => {
                    __classPrivateFieldGet$7(this, _Use_counter, "f").reset();
                    return fn(...args);
                });
            },
            disconnect: () => {
                // cleanup mounts
                for (const down of __classPrivateFieldGet$7(this, _Use_unmounts, "f"))
                    down();
                __classPrivateFieldGet$7(this, _Use_unmounts, "f").clear();
                // cleanup inits
                for (const down of __classPrivateFieldGet$7(this, _Use_initDowns, "f"))
                    down();
                __classPrivateFieldGet$7(this, _Use_initDowns, "f").clear();
                __classPrivateFieldGet$7(this, _Use_initResults, "f").clear();
            },
            reconnect: () => {
                // call all mounts
                for (const up of __classPrivateFieldGet$7(this, _Use_mounts, "f").values())
                    __classPrivateFieldGet$7(this, _Use_unmounts, "f").add(up());
                // call all inits
                for (const [count, start] of __classPrivateFieldGet$7(this, _Use_initStarts, "f").entries()) {
            ...
            afterRender: () => {
                for (const [count, fn] of __classPrivateFieldGet$7(this, _Use_deferred, "f")) {
                    const result = fn();
                    __classPrivateFieldGet$7(this, _Use_deferredResults, "f").set(count, result);
                }
            },
        };
    ...
    mount(fn) {
        ...
        if (!__classPrivateFieldGet$7(this, _Use_mounts, "f").has(count)) {
            __classPrivateFieldGet$7(this, _Use_mounts, "f").set(count, fn);
            __classPrivateFieldGet$7(this, _Use_unmounts, "f").add(fn());
        }
    }
    init(fn) {
        const count = __classPrivateFieldGet$7(this, _Use_counter, "f").pull();
        if (!__classPrivateFieldGet$7(this, _Use_initStarts, "f").has(count)) {
            __classPrivateFieldGet$7(this, _Use_initStarts, "f").set(count, fn);
    ...
    once(prep) {
        const count = __classPrivateFieldGet$7(this, _Use_counter, "f").pull();
        return maptool(__classPrivateFieldGet$7(this, _Use_onces, "f")).guarantee(count, prep);
    }
    defer(fn) {
        const count = __classPrivateFieldGet$7(this, _Use_counter, "f").pull();
        if (!__classPrivateFieldGet$7(this, _Use_deferred, "f").has(count))
            __classPrivateFieldGet$7(this, _Use_deferred, "f").set(count, fn);
        return __classPrivateFieldGet$7(this, _Use_deferredResults, "f").get(count);
    }
    state(init) {
        const count = __classPrivateFieldGet$7(this, _Use_counter, "f").pull();
        const value = maptool(__classPrivateFieldGet$7(this, _Use_states, "f")).guarantee(count, () => ((typeof init === "function")
            ? init()
            : init));
        const setter = (v) => {
    ...
    flatstate(init) {
        const count = __classPrivateFieldGet$7(this, _Use_counter, "f").pull();
        return maptool(__classPrivateFieldGet$7(this, _Use_flatstates, "f")).guarantee(count, () => (flat.state((typeof init === "function")
            ? init()
            : init)));
    }
    signal(init) {
        const count = __classPrivateFieldGet$7(this, _Use_counter, "f").pull();
        return maptool(__classPrivateFieldGet$7(this, _Use_signals, "f")).guarantee(count, () => (signals.signal((typeof init === "function")
            ? init()
            : init)));
    }
    computed(update) {
        const count = __classPrivateFieldGet$7(this, _Use_counter, "f").pull();
        return maptool(__classPrivateFieldGet$7(this, _Use_signals, "f")).guarantee(count, () => (signals.computed(update)));
    }
    op() {
        const count = __classPrivateFieldGet$7(this, _Use_counter, "f").pull();
        return maptool(__classPrivateFieldGet$7(this, _Use_signals, "f")).guarantee(count, () => signals.op());
    }
    watch(collector) {
        const count = __classPrivateFieldGet$7(this, _Use_counter, "f").pull();
        return maptool(__classPrivateFieldGet$7(this, _Use_watches, "f")).guarantee(count, () => watch.track(collector, data => {
    ...
    effect(mount, dependencies) {
        ...
        const count = __classPrivateFieldGet$7(this, _Use_counter, "f").pull();
        const effect = __classPrivateFieldGet$7(this, _Use_effects, "f").get(count);
        if (effect) {
            const [unmount, previous_deps] = effect;
            if (!deep.equal(dependencies, previous_deps)) {
                unmount();
                __classPrivateFieldGet$7(this, _Use_effects, "f").set(count, [mount(), dependencies]);
            }
        }
        else {
            __classPrivateFieldGet$7(this, _Use_mounts, "f").set(count, mount);
            const unmount = mount();
            __classPrivateFieldGet$7(this, _Use_unmounts, "f").add(unmount);
            __classPrivateFieldGet$7(this, _Use_effects, "f").set(count, [unmount, dependencies]);
        }
    }
}
...
class UseShadow extends Use {
    ...
    styles(styles) {
        this.once(() => apply_styles_to_shadow(this.shadow, [this.context.theme, styles !== null && styles !== void 0 ? styles : i$3 ``]));
    }
...
class UseShadowComponent extends UseGold {
}
class UseLightComponent extends UseSilver {
}
class UseLightView extends Use {
    name(name) {
...
class UseShadowView extends UseShadow {
    name(name) {
        this.once(() => this.element.setAttribute("view", name));
    }
}
...
class SlateView extends HTMLElement {
    constructor() {
        super(...arguments);
...
const prepare_light_view = ((shell) => (renderer) => {
    var _instances, _props, _element, _render_into_element, _rerender, _use, _rend, _reactivity, _a;
    return e((_a = class extends f {
            constructor() {
                super(...arguments);
                _instances.add(this);
                _props.set(this, void 0);
                _element.set(this, document.createElement(SlateView.tag));
                _rerender.set(this, debounce(0, () => {
                    if (__classPrivateFieldGet$4(this, _props, "f") && this.isConnected)
                        this.setValue(__classPrivateFieldGet$4(this, _instances, "m", _render_into_element).call(this, this.render(...__classPrivateFieldGet$4(this, _props, "f"))));
                }));
                _use.set(this, new UseLightView(__classPrivateFieldGet$4(this, _element, "f"), __classPrivateFieldGet$4(this, _rerender, "f"), shell.context));
                _rend.set(this, __classPrivateFieldGet$4(this, _use, "f")[usekey].wrap(renderer(__classPrivateFieldGet$4(this, _use, "f"))));
                _reactivity.set(this, setup_reactivity(__classPrivateFieldGet$4(this, _rend, "f"), __classPrivateFieldGet$4(this, _rerender, "f")));
            }
            update(_, props) {
                return __classPrivateFieldGet$4(this, _instances, "m", _render_into_element).call(this, this.render(...props));
            }
            render(...props) {
                var _b;
                __classPrivateFieldSet$4(this, _props, props, "f");
                return (_b = __classPrivateFieldGet$4(this, _reactivity, "f")) === null || _b === void 0 ? void 0 : _b.render(...props);
            }
            reconnected() {
                __classPrivateFieldGet$4(this, _use, "f")[usekey].reconnect();
                __classPrivateFieldSet$4(this, _reactivity, setup_reactivity(__classPrivateFieldGet$4(this, _rend, "f"), __classPrivateFieldGet$4(this, _rerender, "f")), "f");
            }
            disconnected() {
                __classPrivateFieldGet$4(this, _use, "f")[usekey].disconnect();
        ...
        _render_into_element = function _render_into_element(template) {
            j(template, __classPrivateFieldGet$4(this, _element, "f"));
            __classPrivateFieldGet$4(this, _use, "f")[usekey].afterRender();
            return __classPrivateFieldGet$4(this, _element, "f");
        },
        _a));
});
...
function make_view_root({ afterRender, onConnected, onDisconnected, }) {
...
const custom_lit_directive_for_shadow_view = ((c) => ((props, meta = {}) => ({
    ['_$litDirective$']: c,
    values: [{ meta, props }],
})));
...
const prepare_shadow_view = ((shell) => (renderer) => {
    var _input, _first_connection, _root, _rerender, _use, _rend, _reactivity, _a;
    return (custom_lit_directive_for_shadow_view((_a = class extends f {
            constructor() {
                super(...arguments);
                _input.set(this, void 0);
                _first_connection.set(this, true);
                _root.set(this, make_view_root({
                    afterRender: () => __classPrivateFieldGet$3(this, _use, "f")[usekey].afterRender(),
                    onDisconnected: () => this.disconnected(),
                    onConnected: () => {
                        if (!__classPrivateFieldGet$3(this, _first_connection, "f"))
                            this.reconnected();
                        __classPrivateFieldSet$3(this, _first_connection, false, "f");
                    },
                }));
                _rerender.set(this, debounce(0, () => {
                    if (__classPrivateFieldGet$3(this, _input, "f") && this.isConnected)
                        this.setValue(__classPrivateFieldGet$3(this, _root, "f").render_into_shadow(this.render(__classPrivateFieldGet$3(this, _input, "f"))));
                }));
                _use.set(this, new UseShadowView(__classPrivateFieldGet$3(this, _root, "f").container, __classPrivateFieldGet$3(this, _root, "f").shadow, __classPrivateFieldGet$3(this, _rerender, "f"), shell.context));
                _rend.set(this, __classPrivateFieldGet$3(this, _use, "f")[usekey].wrap(renderer(__classPrivateFieldGet$3(this, _use, "f"))));
                _reactivity.set(this, setup_reactivity(__classPrivateFieldGet$3(this, _rend, "f"), __classPrivateFieldGet$3(this, _rerender, "f")));
            }
            update(_, props) {
                return __classPrivateFieldGet$3(this, _root, "f").render_into_shadow(this.render(...props));
            }
            render(input) {
                var _b, _c, _d;
                apply_details(__classPrivateFieldGet$3(this, _root, "f").container, input.meta, (_b = __classPrivateFieldGet$3(this, _input, "f")) === null || _b === void 0 ? void 0 : _b.meta);
                __classPrivateFieldSet$3(this, _input, input, "f");
                __classPrivateFieldGet$3(this, _root, "f").auto_exportparts = ((_c = input.meta.auto_exportparts) !== null && _c !== void 0 ? _c : true);
                return (_d = __classPrivateFieldGet$3(this, _reactivity, "f")) === null || _d === void 0 ? void 0 : _d.render(...input.props);
            }
            reconnected() {
                __classPrivateFieldGet$3(this, _use, "f")[usekey].reconnect();
                __classPrivateFieldSet$3(this, _reactivity, setup_reactivity(__classPrivateFieldGet$3(this, _rend, "f"), __classPrivateFieldGet$3(this, _rerender, "f")), "f");
            }
            disconnected() {
                __classPrivateFieldGet$3(this, _use, "f")[usekey].disconnect();
                if (__classPrivateFieldGet$3(this, _reactivity, "f")) {
                    __classPrivateFieldGet$3(this, _reactivity, "f").stop();
                    __classPrivateFieldSet$3(this, _reactivity, undefined, "f");
                }
            }
        },
        _input = new WeakMap(),
...
class SilverElement extends MetallicElement {
    ...
    constructor() {
        ...
        _SilverElement_wait.set(this, __classPrivateFieldGet$2(this, _SilverElement_init, "f").promise);
    ...
    get updateComplete() {
        return __classPrivateFieldGet$2(this, _SilverElement_wait, "f").then(() => true);
    }
    render() { }
    async requestUpdate() {
        const promise = __classPrivateFieldGet$2(this, _SilverElement_render_debounced, "f").call(this);
        if (__classPrivateFieldGet$2(this, _SilverElement_init, "f")) {
            promise.then(__classPrivateFieldGet$2(this, _SilverElement_init, "f").resolve);
            __classPrivateFieldSet$2(this, _SilverElement_init, undefined, "f");
        }
        __classPrivateFieldSet$2(this, _SilverElement_wait, promise, "f");
        return promise;
    }
    connectedCallback() {
        super.connectedCallback();
...
const prepare_light_component = ((shell) => (renderer) => {
    var _use, _rend, _reactivity, _a;
    return (_a = class extends SilverElement {
            constructor() {
                super(...arguments);
                _use.set(this, new UseLightComponent(this, () => void this.requestUpdate(), shell.context));
                _rend.set(this, __classPrivateFieldGet$1(this, _use, "f")[usekey].wrap(() => renderer(__classPrivateFieldGet$1(this, _use, "f"))));
                _reactivity.set(this, void 0);
            }
            render() {
                var _b;
                this.updateComplete.then(() => __classPrivateFieldGet$1(this, _use, "f")[usekey].afterRender());
                return (_b = __classPrivateFieldGet$1(this, _reactivity, "f")) === null || _b === void 0 ? void 0 : _b.render();
            }
            connectedCallback() {
                super.connectedCallback();
                __classPrivateFieldSet$1(this, _reactivity, setup_reactivity(__classPrivateFieldGet$1(this, _rend, "f"), () => void this.requestUpdate()), "f");
                __classPrivateFieldGet$1(this, _use, "f")[usekey].reconnect();
            }
            disconnectedCallback() {
                super.disconnectedCallback();
                ...
                __classPrivateFieldGet$1(this, _use, "f")[usekey].disconnect();
            }
        },
        _use = new WeakMap(),
        _rend = new WeakMap(),
...
const prepare_shadow_component = ((shell) => (renderer) => {
    var _use, _rend, _reactivity, _a;
    return _a = class extends GoldElement {
            constructor() {
                super(...arguments);
                _use.set(this, new UseShadowComponent(this, this.root, () => void this.requestUpdate(), shell.context));
                _rend.set(this, __classPrivateFieldGet(this, _use, "f")[usekey].wrap(() => renderer(__classPrivateFieldGet(this, _use, "f"))));
                _reactivity.set(this, void 0);
            }
            render() {
                var _b;
                this.updateComplete.then(() => __classPrivateFieldGet(this, _use, "f")[usekey].afterRender());
...
const slate = new Nexus();

const html = (strings, ...values) => (x(strings, ...values.map(Signal.unwrap)));

const styles = i$3 `span { color: green }`;
let outerRenders = 0;
let innerRenders = 0;
const NestingOuter = slate.shadow_view(use => (start) => {
    use.styles(styles);
...
const NestingInner = slate.shadow_view(use => (start) => {
    use.styles(styles);
...
const ObsidianQuadrupler = slate.shadow_view(use => (start) => {
    use.name("quadrupler");
    use.styles(i$3 `span { color: yellow }`);
    const count = use.signal(start);
...
const SlateCarbon = slate.shadow_component(use => {
    use.styles(i$3 `button { color: green }`);
