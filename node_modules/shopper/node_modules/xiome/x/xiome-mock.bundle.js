(function () {
    ...
    class Id {
        constructor(binary) {
            ...
            __classPrivateFieldSet$e(this, _Id_binary, binary, "f");
            __classPrivateFieldSet$e(this, _Id_string, encodeHex(binary), "f");
        }
        ...
        get binary() { return __classPrivateFieldGet$j(this, _Id_binary, "f"); }
        get string() { return __classPrivateFieldGet$j(this, _Id_string, "f"); }
        toBinary() { return __classPrivateFieldGet$j(this, _Id_binary, "f"); }
        toString() { return __classPrivateFieldGet$j(this, _Id_string, "f"); }
        equals(id) {
            return typeof id === "string"
                ? __classPrivateFieldGet$j(this, _Id_string, "f") === id
                : __classPrivateFieldGet$j(this, _Id_string, "f") === id.toString();
        }
    }
    ...
    class RowStorage {
        constructor(storage) {
            ...
            __classPrivateFieldSet$d(this, _RowStorage_storage, storage, "f");
        }
        async save(key, rows) {
            return __classPrivateFieldGet$i(this, _RowStorage_storage, "f").write(key, rows.map(serialize));
        }
        async load(key) {
            var _a;
            const serializedRows = (_a = await __classPrivateFieldGet$i(this, _RowStorage_storage, "f").read(key)) !== null && _a !== void 0 ? _a : [];
    ...
    class Bucket {
        ...
        add(item) {
            __classPrivateFieldGet$h(this, _Bucket_storage, "f").push(item);
            if (__classPrivateFieldGet$h(this, _Bucket_storage, "f").length > __classPrivateFieldGet$h(this, _Bucket_maximum, "f"))
                __classPrivateFieldSet$c(this, _Bucket_storage, __classPrivateFieldGet$h(this, _Bucket_storage, "f").slice(-__classPrivateFieldGet$h(this, _Bucket_maximum, "f")), "f");
        }
        read() {
            return [...__classPrivateFieldGet$h(this, _Bucket_storage, "f")];
        }
    }
    ...
    class RateLimiter {
        ...
        hit() {
            const now = Date.now();
            const old = now - __classPrivateFieldGet$g(this, _RateLimiter_timeframe, "f");
            const hitsWithinTimeframe = __classPrivateFieldGet$g(this, _RateLimiter_bucket, "f").read().filter(time => time > old);
            if (hitsWithinTimeframe.length < __classPrivateFieldGet$g(this, _RateLimiter_maximum, "f")) {
                __classPrivateFieldGet$g(this, _RateLimiter_bucket, "f").add(now);
                return true;
            }
            else {
                return false;
    ...
    class AssertiveMap extends Map {
        ...
        assert(key) {
            if (this.has(key)) {
                ...
                const value = __classPrivateFieldGet$f(this, _AssertiveMap_makeValue, "f").call(this, key);
                this.set(key, value);
                return value;
            }
        }
    ...
    async function assimilateApi({ config, rando, databaseRaw, dacastSdk, sendLoginEmail, signToken, verifyToken, }) {
...
`),
    ...
    function stripeWebhooks({ logger, stripeLiaison, databaseRaw }) {
        return {
    ...
    async function mockStripeCircuit({ rando, tableStorage, databaseRaw, }) {
    ...
    async function assimilateStripe({ databaseRaw, mockStorage, config, rando, }) {
