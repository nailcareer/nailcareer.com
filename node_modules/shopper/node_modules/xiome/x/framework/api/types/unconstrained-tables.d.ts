...
export declare type SchemaToUnconstrainedTables<xSchema extends dbmage.Schema> = {
...
export declare type ReconstrainTable<xTable extends UnconstrainedTable<dbmage.Row>> = xTable extends UnconstrainedTable<infer xRow> ? dbmage.Table<xRow> : never;
export declare type ConstrainMixedTables<xTables extends TablesMixed> = {
...
export declare type ConstrainMixedDatabaseLike<xDatabase extends dbmage.DatabaseLike<any>> = xDatabase extends dbmage.DatabaseLike<infer xTables> ? xTables extends TablesMixed ? dbmage.DatabaseLike<ConstrainMixedTables<xTables>> : never : never;
