...
export declare const backendForBrowser: (storage: FlexStorage) => (config: import("./types/secret-config.js").SecretConfig) => Promise<{
    ...
    api: {
        ...
        example: {
            exampleService: import("renraku").Service<import("../../features/auth/types/auth-metas.js").UserMeta, {
                database: import("dbmage").DatabaseLike<import("dbmage").SchemaToTables<import("dbmage").ConstrainSchema<{
                    "namespace-appId": import("dbmage").Id;
                }, {
                    examplePosts: {
    ...
    databaseRaw: import("dbmage").DatabaseLike<{
        apps: import("dbmage").SchemaToTables<import("dbmage").ConstrainSchema<{
            "namespace-appId": import("dbmage").Id;
        }, {
            registrations: {
        ...
        auth: import("../../framework/api/types/unconstrained-tables.js").SchemaToUnconstrainedTables<import("dbmage").ConstrainSchema<{
            "namespace-appId": import("dbmage").Id;
        }, {
            users: {
                accounts: {
        ...
        notes: import("../../framework/api/types/unconstrained-tables.js").SchemaToUnconstrainedTables<import("dbmage").ConstrainSchema<{
            "namespace-appId": import("dbmage").Id;
        }, {
            notes: import("../../features/notes/types/notes-concepts.js").Database.NoteBase;
            questionDetails: import("../../features/notes/types/notes-concepts.js").Database.NoteDetails.Question;
        }>>;
        store: import("../../framework/api/types/unconstrained-tables.js").SchemaToUnconstrainedTables<import("dbmage").ConstrainSchema<{
            "namespace-appId": import("dbmage").Id;
        }, {
            merchants: {
                stripeAccounts: {
        ...
        videos: import("../../framework/api/types/unconstrained-tables.js").SchemaToUnconstrainedTables<import("dbmage").ConstrainSchema<{
            "namespace-appId": import("dbmage").Id;
        }, {
        ...
        example: import("../../framework/api/types/unconstrained-tables.js").SchemaToUnconstrainedTables<import("dbmage").ConstrainSchema<{
            "namespace-appId": import("dbmage").Id;
        }, {
            examplePosts: {
                exampleId: import("dbmage").Id;
        ...
        questions: import("../../framework/api/types/unconstrained-tables.js").SchemaToUnconstrainedTables<import("dbmage").ConstrainSchema<{
            "namespace-appId": import("dbmage").Id;
        }, {
            questionPosts: {
        ...
        mockAppWindow: ({ appId }: {
            ...
            models: {
                ...
                permissionsModel: {
                    ...
                    track: <X_2>(observer: import("@chasemoskal/snapstate").Observer<{
                        active: boolean;
                        accessOp: import("../../framework/ops.js").Op<import("../../features/auth/types/auth-tokens.js").AccessPayload>;
                        permissionsDisplay: import("../../framework/ops.js").Op<import("../../features/auth/aspects/users/routines/permissions/types/permissions-display.js").PermissionsDisplay>;
                    }, X_2>, reaction?: import("@chasemoskal/snapstate").Reaction<X_2>, options?: {
                        flip?: boolean;
                    }) => () => void;
                    getAccess: () => import("../../features/auth/types/auth-tokens.js").AccessPayload;
                    initialize: () => Promise<void>;
